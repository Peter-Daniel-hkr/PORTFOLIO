...
document.addEventListener("mousemove", function (_ref) {
  ...
  timeout = window.requestAnimationFrame(function () {
    ...
    cards.style.transform = "rotateX(".concat(yValue, "deg) rotateY(").concat(xValue, "deg)");
    [].forEach.call(images, function (image) {
      image.style.transform = "translateX(".concat(-xValue, "px) translateY(").concat(yValue, "px)");
    });
    [].forEach.call(backgrounds, function (background) {
      background.style.backgroundPosition = "".concat(xValue * 0.45, "px ").concat(-yValue * 0.45, "px");
    });
  });
}, false);
